...
/*
 * This file is the entry point for the CLI using node -r
 * This file mantaine the retrocompatibility for functionality:
 ...
 * @param runner
 */
export function runNodeCli(runner: (config: DotenvConfig) => unknown): unknown {
	// Empty options
